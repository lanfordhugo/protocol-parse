...
description: AI Python 代码质量审查专家,基于 PEP 8、PEP 257 和 Python 最佳实践进行全面的代码质量检查。在以下场景使用: (1) 审查 Python 代码的功能正确性与健壮性 (2) 检查代码效率与性能 (3) 验证安全性 (4) 评估并发与同步实现 (5) 审查设计质量与 SOLID 原则 (6) 检查编码标准与风格符合性 (7) 评估可读性与可维护性 (8) 验证可测试性
---
