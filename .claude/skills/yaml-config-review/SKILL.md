...
description: YAML配置审查工作流，从多视角检查协议配置的正确性。使用场景：审查V8Parse项目的协议YAML配置文件，验证配置与文档的一致性。包括自动化验证、结构完整性审查、逐CMD深度审查、交叉验证和边界情况检查。
---
...
完整的YAML配置规范请参考 `/protocol-to-yaml` 技能文档，包含：
