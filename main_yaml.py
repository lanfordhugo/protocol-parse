# main_yaml.py - 基于YAML配置的协议解析框架
"""
完全基于YAML配置的协议解析框架
不再依赖protocol_configs.py，直接从YAML配置文件加载协议信息
"""
...
使用示例:
  python main_yaml.py v8        # 解析V8协议
  python main_yaml.py xiaoju    # 解析小桔协议
  python main_yaml.py yunwei    # 解析运维协议
  python main_yaml.py sinexcel  # 解析Sinexcel协议
  python main_yaml.py --list    # 列出所有协议
  python main_yaml.py --validate # 验证所有配置
